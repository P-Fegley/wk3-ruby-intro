...
puts "How much bitcoin do you have (USD)?"
bitcoin = gets.chomp
...
# p bitcoin_data
bitcoin_value_USD = bitcoin_data["bpi"]["USD"]["rate_float"].round(2)

puts "1 Bitcoin is valued at $#{ bitcoin_value_USD }"
puts "Your Bitcoin is worth $#{ bitcoin * bitcoin_value_USD }"
